...
public abstract class AbstractMessageHandler implements MessageHandle {
    ...
    public abstract void userMessage(UserMessage userMessage) throws SocketException, UnknownHostException;

    public abstract void groupMessage(GroupMessage groupMessage) throws SocketException, UnknownHostException;
