...
public class StartUI extends WechatApi {
    ...
    private void listen() throws SocketException, UnknownHostException {
        while (true) {
            // retcode, selector
    ...
    private void handle_mod(JsonObject dic) throws SocketException, UnknownHostException {
    ...
    public void handle_msg(JsonObject dic) throws SocketException, UnknownHostException {
    ...
    private void handle(int selector) throws SocketException, UnknownHostException {
        switch (selector) {
            case 2:
